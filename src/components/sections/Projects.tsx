      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-14 grid gap-6 md:grid-cols-2 xl:grid-cols-3">
          {projects.map((project, index) => (
            <article
              key={project.slug}
              className="group flex h-full flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm transition duration-300 hover:-translate-y-1 hover:border-cyan-300 hover:shadow-lg"
            >
              ...
              <div className="flex flex-1 flex-col p-6">
                ...
                <div className="mt-7 border-t border-slate-100 pt-5">
                  <span className="text-sm font-semibold text-slate-400">
                    Halaman detail segera tersedia
                  </span>
                </div>
              </div>
            </article>
